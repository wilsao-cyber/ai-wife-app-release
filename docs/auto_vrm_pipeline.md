...
# 或手動執行兩階段
cd 2D_Stage && python webui.py --input ../../Pictures/post-image-33571620.jpeg
...
bash scripts/auto_vrm_pipeline.sh /home/wilsao6666/Pictures/post-image-33571620.jpeg
```
